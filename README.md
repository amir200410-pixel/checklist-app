# מנהל המשימות - מערכת ניהול משימות מתקדמת
...
הפרויקט מוגן תחת רישיון MIT. ראה קובץ [LICENSE](LICENSE) לפרטים מלאים.

### 🛡️ הגנה על זכויות יוצרים:
- ✅ **הקוד מוגן** תחת רישיון MIT
- ✅ **שימוש חופשי** למטרות חינוכיות ומסחריות
- ✅ **נדרש ייחוס** למפתח המקורי
- ✅ **אחריות מוגבלת** על השימוש
